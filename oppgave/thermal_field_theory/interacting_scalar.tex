...
% TODO: Sjekk fortegn forran J phi
\begin{align}
...
Using Wick's theorem, as described in (INTRO EFFECTIVE FIELD THEORY) the expectation values we are evaluating can be written
\begin{align*}
    \ex{{S_I}^m} & 
