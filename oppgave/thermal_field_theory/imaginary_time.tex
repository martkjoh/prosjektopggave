...
Due to the finite range of the imaginary-time coordinate $\tau \in [0, \beta]$, the momentum-space fields in imaginary-time formalism has a discrete coordinate. 
...
The dot product is $X\cdot P = \omega_n \tau + \vec k \cdot \vec x$.
