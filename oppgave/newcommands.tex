...
\newcommand{\Veff}{\mathcal{V}_{\mathrm{eff}}} % effective potential
\newcommand{\Em}{\mathcal{M}}       % Manifold M
\newcommand{\Ef}{\mathcal{F}}       % Fancy f
\newcommand{\R}{\mathbb{R}}         % Real numbers
\newcommand{\chpt}[0]{\ensuremath{\chi \text{PT}}}       % Chiral pertubation theory
\newcommand{\SU}{\mathrm{SU}}       % SU(n)
\renewcommand{\U}{\mathrm{U}}       % U(n)
\newcommand{\SO}{\mathrm{SO}}
\newcommand{\Olie}{\mathrm{O}}
...
\newcommand{\funcdv}[1]{\frac{\delta }{\delta #1}}
