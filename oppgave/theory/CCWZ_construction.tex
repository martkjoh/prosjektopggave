...
This section is based on~\cite{weinberg_1996_vol2,The_composite_NG_Higgs,effective_FT_with_NG_modes,morrison:ccwz_presentation}, as well as the original papers~\cite{Structure_of_phen_1,Structure_of_phen_2}.
...
% There are $n = \dim G$ parameters $\eta_\alpha$, but Goldstone's theorem massless mode per broken generator.
...
This means that, in a neighborhood $U \subset G$ of the identity, each element $g$ has a unique representation $g = \tilde \Sigma$~\cite{smooth_manifolds}.
