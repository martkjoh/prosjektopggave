...
In this limit, we may use the stationary phase approximation, as described in \autoref{section:Functional derivative}, which gives
\begin{equation}
...
\end{align*}
%
The first term is quadratic in $\eta$, and can therefore be evaluated as a generalized Gaussian integral, as described in \autoref{section:Functional derivative},
\begin{align*}
    & 
    \ln\Bigg\{
        \int \D \eta \, 
