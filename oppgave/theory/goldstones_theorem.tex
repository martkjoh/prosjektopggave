...
As we have discussed, symmetry transformation will leave the governing equation of a theory unchanged.
This, however, does not imply that a physical state, such as the ground state, is invariant under this transformation.
