...
\begin{align}
    ...
    % \left[
    %     (
    %         -\frac{1}{2}(\bar l_4 - 1 - \frac{1}{\epsilon} - \ln\frac{\tilde \mu^2}{M^2})
    %         + 2(\bar l_3 - 1 - \frac{1}{\epsilon} - \ln\frac{\tilde \mu^2}{M^2})
    %     )\bar m^4
...
\end{equation}
The difference of the masses turn out to $m_1^2 - m_2^2 = \mu^2 \sin^2\alpha = \Oh[2]{\alpha}$, and can therefore be dropped.
We further rewrite
\begin{equation}
