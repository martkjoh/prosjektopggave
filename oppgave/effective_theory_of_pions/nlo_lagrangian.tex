...
Constructing the next-to-leading order, NLO for short, Lagrangian is now a buisniess of combining the building blocks we found in \autoref{section:chiral pertubation theory} to terms that obey all symmetries and that are fourth order in Weinberg's power counting scheme, and remove possible redundant terms.
