...
The effective action can not in general be written as a single integral over a power series in the field, it might for example be non-local~\cite{Schwartz:QFT}.
